 ...
 */
  public static function item_html($review=NULL)
  {
 ...
 */
  public static function embed_code($apikey, $type=NULL, $jquery=TRUE)
  {
    ...
    ob_start();
    ?><div id="plusPandaYes"></div><script type="text/javascript" src="<?php echo url::site()?>?apikey=<?php echo $apikey?>&fetch=reviews<?php echo $jquery?>" charset="utf-8"></script><?php
    if('fake' == $type)
      return str_replace(
        array('<','>',"\n","\r","\t"),
        array('&lt;','&gt;'),
