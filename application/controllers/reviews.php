 ...
 */
  ...
  {      
    ...
    $tag_list     = r_build::tag_filter($this->site->categories, $this->active_tag);
    $add_wrapper  = r_build::add_wrapper();
    $summary      = r_build::summary(array(1));
    $sorters      = r_build::sorters($this->active_tag, $this->active_sort,'', 'widget');
    $item_html    = r_build::item_html();
