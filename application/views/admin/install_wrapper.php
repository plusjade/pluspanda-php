...
<div class="install-page">
	...
	<textarea>&lt;div id="plusPandaYes"&gt;&lt;a href="http://<?php echo $this->site_name .'.'. ROOTDOMAIN?>"&gt;View Our Customer Reviews!&lt;/a&gt;&lt;/div&gt;&lt;script type="text/javascript" src="http://<?php echo $this->site_name?>.panda.com/admin/js/widget" charset="utf-8"&gt;&lt;/script&gt;</textarea>
	...
	<textarea>&lt;div id="plusPandaYes"&gt;&lt;a href="http://<?php echo $this->site_name.'.'. ROOTDOMAIN?>"&gt;View Our Customer Reviews!&lt;/a&gt;&lt;/div&gt;&lt;script type="text/javascript" src="http://<?php echo $this->site_name?>.panda.com/admin/js/widget?jquery=false" charset="utf-8"&gt;&lt;/script&gt;</textarea>
