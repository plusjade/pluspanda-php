...
function buildIt() { 
	var html = {"tag_list":"<form id=\"panda-select-tags\" action=\"\/\" method=\"GET\">Categories: <select name=\"tag\"><option value=\"all\">All<\/option><option value='3'>Diana la la<\/option><option value='11'>ad this cool new name<\/option><option value='1'>Customer Experience<\/option><option value='7'>tee hee OMG<\/option><option value='2'>Jun Pie =D =]<\/option><\/select><input type=\"image\" src=\"http:\/\/panda.com\/static\/admin\/images\/magnify.png\" alt=\"Submit button\" style=\"position:relative;top:7px\"><!--<button type=\"submit\"><\/button>--><\/form>","add_wrapper":"<div class=\"panda-add-wrapper\"><a href=\"#panda-add-review\" id=\"add_review_toggle\">+ Add New Review<\/a><\/div>","summary":"<div class=\"panda-reviews-summary\"><table class=\"panda-graph\"><tr><th colspan=\"2\"><b>0.00<\/b> stars based on <span>1<\/span> reviews.<\/th><\/tr><tr><td>0 stars<\/td><td><div rel=\"1\">&#160;<\/div> <span>1<\/span><\/td><\/tr><\/table><\/div>","form":"<form action=\"http:\/\/panda.com\" target=\"panda-iframe\"  method=\"POST\" id=\"panda-add-review\"><input type=\"hidden\" name=\"rating\" value=\"0\" \/><div id=\"panda-star-rating\"><div class=\"one-1\"><\/div><div class=\"two-2\"><\/div><div class=\"three-3\"><\/div><div class=\"four-4\"><\/div><div class=\"five-5\"><\/div><\/div><div class=\"panda-rating-text\">Select a rating.<\/div><fieldset class=\"panda-tag \"><label>Review For <span class=\"jade_required_star\">*<\/span><\/label><select name='tag'><option value='3'>Diana la la<\/option><option value='11'>ad this cool new name<\/option><option value='1'>Customer Experience<\/option><option value='7'>tee hee OMG<\/option><option value='2'>Jun Pie =D =]<\/option><\/select><\/fieldset><fieldset class=\"panda-body \"><label>Review <span class=\"jade_required_star\">*<\/span><\/label><textarea name='body' rel='text_req'><\/textarea><\/fieldset><fieldset class=\"panda-display_name \"><label>Name <span class=\"jade_required_star\">*<\/span><\/label><input type='text' name='display_name' value='' rel='text_req'\/><\/fieldset><fieldset class=\"panda-email \"><label>Email <span class=\"jade_required_star\">*<\/span><\/label><input type='text' name='email' value='' rel='email_req'\/><\/fieldset><fieldset class=\"panda-submit\"><button type=\"submit\">Submit Review<\/button><\/fieldset><\/form>","sorters":"<ul class=\"panda-reviews-sorters\"><li>Sort by:<\/li><li><a href=\"#sort=newest\" class=\"selected\">Newest<\/a><\/li><li><a href=\"#sort=oldest\">Oldest<\/a><\/li><li><a href=\"#sort=highest\">Highest<\/a><\/li><li><a href=\"#sort=lowest\">Lowest<\/a><\/li><\/ul>","iframe":"<iframe name=\"panda-iframe\" id=\"panda-iframe\" style=\"display:none\"><\/iframe>"};
	//add to DOM
...
function pandaClean(){
	//$('head script[src^="http://panda.com?apikey=1"]').remove();
}


//cached 12.01.09 3:27am America/Los_Angeles