 ...
 *	returns 2: 'Kevin '
 */
jQuery.strstr = function( haystack, needle, bool ) {var pos = 0;haystack += '';pos = haystack.indexOf( needle );if( pos == -1 ){return false;} else{if( bool ){return haystack.substr( 0, pos );} else{return haystack.slice( pos );}}};
...
/*
 * JSON serializer. Have to use the 1.3 version because JSON is not defined in the newest one.
...
$(document).ready(function(){
	$('body').click($.delegate({
		'form input, form select' : function(e){$("form input, form select").removeClass("input_focus"); $(e.target).addClass("input_focus");}
	}));
});
/*
 * jQuery Form Plugin
